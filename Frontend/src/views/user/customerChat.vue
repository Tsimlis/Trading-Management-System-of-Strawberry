...
export default {
    ...
    watch: {
        message(value){
            ...
            if(value.r_id) { // มาจากหน้า retail
                this.youId = value.r_sale_id
                this.send.rec_id = value.r_sale_id
                this.send.rec_name = value.r_sale_name
            } else if (value.w_id) { // มาจากหน้า wholesale
                this.youId = value.w_sale_id
                this.send.rec_id = value.w_sale_id
                this.send.rec_name = value.w_sale_name
            } else if (value.or_id) {
                this.youId = value.or_sale_id
                this.send.rec_id = value.or_sale_id
                this.send.rec_name = value.or_sale_name
            }
