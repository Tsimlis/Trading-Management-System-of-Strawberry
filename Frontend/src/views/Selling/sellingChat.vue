...
export default {
    ...
    watch: {
        message(value){
            ...
            if(value.or_id) { // มาจากหน้า buyfarmer
                this.youId = value.or_customer_id
                this.send.rec_id = value.or_customer_id
                this.send.rec_name = value.or_customer_name
                // console.log('or',this.youId)
                ...
                // console.log('f',this.youId)
            }
            
            // ฟังกชันแสดงข้อความของทั้ง 2 คน
            this.getMessage();
            // setInterval(() => { this.getMessage(); }, 5000); ////////////////////////////////////////////ปัญหาคือไม่หยุด
